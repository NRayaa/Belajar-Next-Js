          ...
          <div className="layout grid grid-cols-12">
            ...
            <div className="col-span-12 xl:col-span-10 min-h-screen py-5 px-5">
              ...
              <div className="border-2 rounded-[1rem] px-5 sm:px-10 pt-5 pb-10 mt-10">
                <h1 className="text-[2rem] font-semibold">Buat Guru</h1>
                <div className="mt-10 space-y-5">
                  ...
                  <div className="w-full items-center">
                    <Label htmlFor="kelas">Mapel</Label>
                    <Select>
                      <SelectTrigger className="w-full">
                        <SelectValue placeholder="Pilih mapel" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="A">PAI</SelectItem>
                        <SelectItem value="B">B. Indo</SelectItem>
                        <SelectItem value="C">MTK</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                </div>
